// v6 - ignora devoluções (pedidos começando com 0)
...
function parseLines(lines) {
  ...
  for (const line of lines) {
    ...
    // Ignora devoluções: número do pedido começa com 0 (ex: 0072527)
...
app.listen(PORT, () => console.log(`Painel Douratubos v6 rodando em http://localhost:${PORT}`));
